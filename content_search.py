...
Handles searching Pinecone for relevant content, lesson-aware filtering,
and content ranking for the AI Professor Platform.
"""
...
class ContentSearchEngine:
    ...
    def search_course_content(self, query: str, course_namespace: str, 
                            conversation_context: ConversationContext, 
                            current_lesson: str = "all", top_k: int = 8) -> Dict:
        ...
        try:
            ...
            # Build lesson-aware filter and search parameters
            base_filter = {"course": course_namespace}
            search_top_k = top_k * 3 if current_lesson != "all" else top_k
            ...
            if not processed_chunks["selected_chunks"]:
    ...
    def _enhance_query_with_context(self, query: str, conversation_context: ConversationContext) -> str:
        """Enhance query with conversation context for better search relevance"""
